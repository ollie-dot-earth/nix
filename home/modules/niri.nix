...

{
  ...
  programs.niri = {
    ...
    settings = {
        ...
        outputs."Virtual-2".position = { x = -30000; y = 0; };
...
# Startup spawns!
        ...
        binds = {
          ...
          "Mod+Shift+Left".action.move-column-left = [ ];
                ...
                "Mod+WheelScrollDown" = { action.focus-window-or-workspace-down = [ ]; cooldown-ms = 150; };
                "Mod+WheelScrollUp" = { action.focus-window-or-workspace-up = [ ]; cooldown-ms = 150; };
                ...
                "Super+L" = {
                  action.spawn = [ "sh" "-c" "niri msg action spawn -- hyprlock && niri msg action power-off-monitors" ];
